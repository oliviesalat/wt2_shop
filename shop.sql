...
VALUES (1, 6, '2025-06-26 13:37:45'),
...
VALUES (1, 1, 23, 'Electric Kettle', 29.99, 4),
...
INSERT INTO `products` (`id`, `name`, `category_id`, `description`, `price`)
VALUES (23, 'Electric Kettle', 1, '1.5L capacity, stainless steel', 29.99),
...
INSERT INTO `test` (`id`, `test1`, `test2`, `test3`)
VALUES (1, 'hello', 2, 3),
       (2, 'hello', 2, 3);
...
INSERT INTO `users` (`id`, `name`, `surname`, `email`, `telephone`, `password`, `role_id`)
VALUES (3, 'sefsef', 'sefsefsef', 'semo.suslo@gmail.com', '32434234',
        '$2y$10$TT1z8t9C9tDOA8izsGKcuOmtGlphSlC32CJ9EFcf8mMLCQNSdGdR6', 1),
       (5, 'sdfgsdfgsdfg', 'fdsfgsdfg', 'fgdfgdfgdfg@fsdf.co', '234523452345',
        '$2y$10$I4.m5ltkg8ILAhEyOWqYhus3O.TCeOS13/9X5Mj16JDdeXQk5rqHq', 1),
       (6, 'test', 'test', 'test@test.com', '32434234', '$2y$10$JqsRazN1xR2.qvW4jgtoBu0kdRio18XXP/cFcgtijH6iUKCccXirK',
        3),
       (7, 'user', 'userov', 'user@user.com', '3243423413123',
        '$2y$10$QdAb.i4nuu7QkoEpVjZYXuq3mur1iI6X.jaQnUeAEsrqVYIoxcV3S', 1);
